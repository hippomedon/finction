...
-->
	...
	<c:otherwise> --%>
	<a href='RankingListServlet?flag=getAllweek&page=${page-1 }' class = "fan">上一页</a>
		        <c:forEach var="i" begin="1" end="${pageNum }">
		        	<c:choose>
		        		<c:when test="${page==i }">
		        		...
		        		<c:otherwise>
		        			<a href='RankingListServlet?flag=getAllweek&page=${i }' class="curr">${i }</a>
		        		</c:otherwise>
		        	</c:choose>
		        </c:forEach>
	       
	       <a href='RankingListServlet?flag=getAllweek&page=${page+1 }' class = "fan">下一页</a>
