...
<body>
    <form class="layui-form layui-form-pane" action="AdminServlet?flag=addadmin" method="post" style="padding:10% 30% 0 30%;  height:378px; width: 320px;">
        ...
        <div class="layui-inline">
      		...
      		<div class="layui-input-inline">
        		<input type="text" name="email" lay-verify="email" autocomplete="off" class="layui-input" placeholder="请输入">
      		</div>
    	</div>
        <div class="layui-form-item">
